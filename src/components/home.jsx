            ...
            <div className="grid place-items-center w-screen h-screen">
                <div>
                    <div className="flex justify-center w-full h-96">
                        <div className="w-96 h-96 bg-valorantblack rounded-lg border-2 border-valorantred mb-5 drop-shadow-lg"><img src="/valorant_logo.png" alt="My Image" /></div>
                    </div>
                    <div className="bg-valorantblack rounded-lg border-2 border-valorantred my-5 drop-shadow-lg">
